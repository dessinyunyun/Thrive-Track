...
// The Form_ResponseFunc type is an adapter to allow the use of ordinary
// function as Form_Response mutator.
type Form_ResponseFunc func(context.Context, *ent.FormResponseMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f Form_ResponseFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.FormResponseMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.FormResponseMutation", m)
}

// The History_AnswerFunc type is an adapter to allow the use of ordinary
// function as History_Answer mutator.
type History_AnswerFunc func(context.Context, *ent.HistoryAnswerMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f History_AnswerFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.HistoryAnswerMutation); ok {
		return f(ctx, mv)
	}
