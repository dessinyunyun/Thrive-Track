...
type Usecase struct {
	repo history_answer.HistoryAnswerRepository
	ctx  context.Context
}

func NewHistoryAnswerUsecase(repo history_answer.HistoryAnswerRepository, ctx context.Context) *Usecase {
	return &Usecase{
		repo: repo,
		ctx:  ctx,
	}
...
func (uc *Usecase) Create(c *gin.Context) error {
	var create *history_answer.Form
